...
Contributions will be of many kinds.  While we cannot hope to anticipate all of the types of contributions, here is a short sampling that provides a sense for the range we expect:
